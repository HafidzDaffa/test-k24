        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ auth()->user()->role == "admin" ? route('admin.index') : '#' }}">
                <div class="d-flex flex-row">
                    ...
                    {{ auth()->user()->role == "admin" ? 'ADMIN' : 'MEMBER' }} MENU
                </div>
            </a>
            ...
            <li class="nav-item {{ request()->path() == 'dashboard-admin' ? 'active' : '' }}">
                <a class="nav-link" href="{{ auth()->user()->role == "admin" ? route('admin.index') : route('member.index') }}">
            ...
            @if (auth()->user()->role == "admin")  
                ...
                <li class="nav-item {{ request()->path() == 'user-list' ? 'active' : '' }}">
